...
CREATE TABLE `lr_address` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户收货地址表';
...
CREATE TABLE `lr_guanggao` (
  ...
  `action` varchar(255) DEFAULT NULL COMMENT '链接值',
...
-- ----------------------------
INSERT INTO `lr_program` VALUES ('1', '贺州休闲山庄', '贺州休闲山庄', 'UploadFiles/logo/1493258832314637.jpg', 'Copyright © 2017', 'weixin', '0200202002', '1515805778', '1', '0.00');
...
CREATE TABLE `lr_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '用户表：包括后台管理员、商家会员和普通会员',
  `name` varchar(20) DEFAULT NULL COMMENT '登陆账号',
  `uname` varchar(10) DEFAULT NULL COMMENT '昵称',
  `username` varchar(255) DEFAULT NULL COMMENT '用户登录后台账号',
  `pwd` varchar(50) DEFAULT NULL COMMENT 'MD5密码',
  `addtime` int(11) NOT NULL DEFAULT '0' COMMENT '创建日期',
  `jifen` float(11,0) DEFAULT '0' COMMENT '积分',
  `photo` varchar(255) DEFAULT NULL COMMENT '头像',
  `tel` char(15) DEFAULT NULL COMMENT '手机',
  `qq_id` varchar(20) DEFAULT '0' COMMENT 'qq',
  `email` varchar(50) DEFAULT NULL COMMENT '邮箱',
  `sex` tinyint(2) DEFAULT '0' COMMENT '性别',
  `del` tinyint(2) DEFAULT '0' COMMENT '状态',
  `openid` varchar(50) DEFAULT NULL COMMENT '授权ID',
  `source` varchar(10) DEFAULT NULL COMMENT '第三方平台(微信，QQ)',
  `shop_id` int(11) DEFAULT '0' COMMENT '店铺id',
