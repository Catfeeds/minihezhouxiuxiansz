...
Page({
  ...
  onLoad(options) {
    ...
    //获取省级城市
    my.httpRequest({
      url: app.data.ceshiUrl + '/Api/Address/get_province',
      data: {},
      method: 'POST',
  ...
  bindPickerChangeshengArr(e) {
    ...
    var that = this;
    my.httpRequest({
      url: app.data.ceshiUrl + '/Api/Address/get_city',
  ...
  bindPickerChangeshiArr: function (e) {
    ...
    var that = this;
    my.httpRequest({
      url: app.data.ceshiUrl + '/Api/Address/get_area',
      data: {
        city:e.detail.value,
  ...
  bindPickerChangequArr: function (e) {
    ...
    var that = this;
    my.httpRequest({
      url: app.data.ceshiUrl + '/Api/Address/get_code',
      data: {
        quyu:e.detail.value,
        city:this.data.city
      },
  ...
  formSubmit(e) {
    ...
    my.httpRequest({
      url: app.data.ceshiUrl + '/Api/Address/add_adds',
      data: {
