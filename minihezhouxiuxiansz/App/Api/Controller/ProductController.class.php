...
class ProductController extends PublicController {
	...
	public function detail(){
		...
		echo json_encode(array('status'=>1,'content'=>$content,'pro'=>$pro,'lun'=>$lun,'quan'=>$quan,'param'=>$param,'prodetail'=>$prodetail2,'shu'=>$shu,'guei'=>$guei,'num'=>$num,'num2'=>$num2,'ppid'=>$ppid,'param2'=>$param2));
	}
